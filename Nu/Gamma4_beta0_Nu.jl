...
# 9. Initial condition
#
# Same strategy as other Gamma = 4 validation cases:
#
...
video_path = joinpath(
    output_dir,
    "Wang_Gamma4_beta0_n4.mp4",
)

nusselt_path = joinpath(
    output_dir,
    "Wang_Gamma4_beta0_n4_Nusselt.png",
)

stable_nusselt_path = joinpath(
    output_dir,
    "Wang_Gamma4_beta0_n4_Nusselt_stable.png",
)
...
println(
    "Target state: Gamma = 4, beta = 0 deg, n = 4",
)
