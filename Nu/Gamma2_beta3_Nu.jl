...
# Horizontal resolution = 2 × 128 = 256
# ============================================================
...
# 9. Initial condition
#
# Same strategy as other Gamma = 2 validation cases:
#
...
video_path = joinpath(
    output_dir,
    "Wang_Gamma2_beta3_n4.mp4",
)

nusselt_path = joinpath(
    output_dir,
    "Wang_Gamma2_beta3_n4_Nusselt.png",
)

stable_nusselt_path = joinpath(
    output_dir,
    "Wang_Gamma2_beta3_n4_Nusselt_stable.png",
)
...
println(
    "Target state: Gamma = 2, beta = 3 deg, n = 4",
)
