...
# ============================================================
# 3. Temperature + velocity + mesh + gravity arrow
# ============================================================
...
function fig2plot(
    ...
    # --------------------------------------------------------
    # Uniform velocity-arrow positions
    # --------------------------------------------------------
...
# Horizontal resolution = 4 × 128 = 512
# ============================================================
...
#
# Target: Gamma = 4, beta = 3 deg, four-roll branch
# ============================================================
...
video_path = joinpath(
    output_dir,
    "Wang_Gamma4_beta3_n4.mp4",
)

nusselt_path = joinpath(
    output_dir,
    "Wang_Gamma4_beta3_n4_Nusselt.png",
)

stable_nusselt_path = joinpath(
    output_dir,
    "Wang_Gamma4_beta3_n4_Nusselt_stable.png",
)
...
#
# Same method as previous Gamma = 2 validation:
# average over t = 80 ... 100
# ============================================================
...
println(
    "Target state: Gamma = 4, beta = 3 deg, n = 4",
)
